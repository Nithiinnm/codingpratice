package com.mvn.interview.prepartion.java8;
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		List<Student> lstStuName = list.stream().filter(dt -> dt.getFirstName().startsWith("A"))
			...
			List<Student> startWithS = list.stream().filter(parameter -> parameter.getFirstName().startsWith("S")).collect(Collectors.toList());
